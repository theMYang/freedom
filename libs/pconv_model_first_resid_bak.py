...
#         self.vgg = self.build_vgg()
    ...
    def build_pconv_unet(self, train_bn=True, lr=0.0002):      
        ...
        resid1 = Subtract()([e_conv3_head, e_conv3_tail])

        d_conv4 = decoder_layer(e_conv3_tail, e_conv2_tail, 64, 3)
        resid1 = Subtract()([d_conv4, e_conv2_head])

        d_conv5 = decoder_layer(d_conv4, e_conv1_tail, 32, 3)
        resid1 = Subtract()([d_conv5, e_conv1_head])

        d_conv6 = decoder_layer(d_conv5, inputs_img, 16, 3, bn=False)
